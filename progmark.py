...
with open("extraire.txt", "r") as fichier:
    ipsr = []
    ipde = []
    longueur = []
    flag = []
...
<html lang="fr">
   <head>
      ...
      <style>
      body{
          background-image: url('https://cdn.pixabay.com/photo/2019/04/09/18/19/block-chain-4115197_1280.jpg');
